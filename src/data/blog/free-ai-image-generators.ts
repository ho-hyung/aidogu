...
<h2>1. Stable Diffusion (스테이블 디퓨전)</h2>
<h3>특징</h3>
<p>Stability AI가 개발한 오픈소스 이미지 생성 모델입니다. 완전히 무료로 사용할 수 있으며, 로컬 컴퓨터에 설치하여 무제한으로 이미지를 생성할 수 있다는 것이 가장 큰 장점입니다.</p>
...
<h2>2. Microsoft Designer (마이크로소프트 디자이너)</h2>
<h3>특징</h3>
<p>마이크로소프트가 제공하는 무료 AI 이미지 생성 도구입니다. DALL-E 3 모델을 기반으로 하며, 마이크로소프트 계정만 있으면 누구나 사용할 수 있습니다.</p>
...
<h2>3. Leonardo AI (레오나르도 AI)</h2>
<h3>특징</h3>
<p>게임 아트와 캐릭터 디자인에 특화된 AI 이미지 생성 플랫폼입니다. 무료 플랜에서도 하루 150크레딧을 제공하여 여러 장의 이미지를 생성할 수 있습니다.</p>
...
<h3>프롬프트 작성 팁</h3>
<ul>
  <li><strong>구체적으로 묘사하세요</strong> - "예쁜 풍경" 대신 "눈 덮인 산봉우리 위로 주황색 석양이 지는 풍경, 전경에 소나무 숲"</li>
  <li><strong>스타일을 지정하세요</strong> - "유화 스타일", "수채화", "사실적 사진", "미니멀 일러스트" 등</li>
  <li><strong>구도와 조명을 언급하세요</strong> - "클로즈업", "항공 촬영", "골든 아워 조명", "스튜디오 조명" 등</li>
  <li><strong>부정 프롬프트를 활용하세요</strong> - 원하지 않는 요소를 명시하면 더 정확한 결과를 얻을 수 있습니다</li>
</ul>

<h3>저작권 주의사항</h3>
<p>AI로 생성한 이미지의 저작권은 플랫폼마다 정책이 다릅니다. 상업적 사용을 계획한다면 각 도구의 이용약관을 반드시 확인하세요. 특히 특정 아티스트의 스타일을 모방한 이미지나 실존 인물의 이미지 생성은 법적 문제가 될 수 있으니 주의가 필요합니다.</p>

<h2>마무리</h2>
<p>무료 AI 이미지 생성 도구는 각각의 특색이 뚜렷합니다. 완전한 자유도와 무제한 사용을 원한다면 <strong>Stable Diffusion</strong>, 가장 쉬운 사용법을 원한다면 <strong>Microsoft Designer</strong>나 <strong>Canva AI</strong>, 넉넉한 무료 사용량을 원한다면 <strong>Playground AI</strong>, 게임/캐릭터 아트에는 <strong>Leonardo AI</strong>를 추천합니다.</p>
<p>직접 여러 도구를 사용해 보고 자신에게 맞는 도구를 찾아보세요. AIDogu에서 더 많은 AI 이미지 생성 도구를 비교해 볼 수 있습니다.</p>
`,
}
